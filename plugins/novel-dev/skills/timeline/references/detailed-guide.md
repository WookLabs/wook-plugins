# Timeline Skill - Detailed Guide

## Overview

This skill provides comprehensive functionality for the timeline operation in the novel development workflow.

## When to Use

Use this skill when you need to perform timeline operations on your novel project.
...
For complete documentation, see the SKILL.md file in: skills/timeline/
