# Blueprint Gen Skill - Detailed Guide

## Overview

This skill provides comprehensive functionality for the blueprint-gen operation in the novel development workflow.

## When to Use

Use this skill when you need to perform blueprint-gen operations on your novel project.
...
For complete documentation, see the SKILL.md file in: skills/blueprint-gen/
