...
| beta-reader | ≥80점 | **≥85점** | 몰입도/이탈 예측 |
| genre-validator | ≥95점 | **≥97점** | 장르 요구사항 충족 |

**모든 validator가 통과해야 품질 게이트 통과**

> **참고**: `/write-all` 커맨드는 **Masterpiece Mode**를 사용합니다. 이는 Standard Mode (critic ≥70, beta-reader ≥70, genre-validator ≥85)보다 엄격한 기준입니다.
